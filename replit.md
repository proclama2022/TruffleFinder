# Truffle Camp - Event Landing Page

## Overview

This is a modern, bilingual (Italian/English) event landing page for "Truffle Camp" - a specialized event for Lagotto Romagnolo dogs and their owners. The application features a beautiful, responsive design with truffle-themed styling, comprehensive event information, and integrated booking/contact functionality.
